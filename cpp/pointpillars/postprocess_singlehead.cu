...
PostprocessCudaSingle::PostprocessCudaSingle(const int num_threads, const float float_min, const float float_max,
...
void PostprocessCudaSingle::DoPostprocessCuda(
    float* cls_pred_0,
    ...
    // kitti的single head输出为一个(1, 321408, 3)的cls_preds 和一个(1, 321408, 7)的box_preds 
