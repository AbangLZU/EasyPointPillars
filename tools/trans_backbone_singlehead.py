...
def parse_config():
    ...
    parser.add_argument('--output_path', type=str, 
                        default='../output/kitti/backbone_head.onnx', 
...
if __name__ == "__main__":
    ...
    print('input to backbone size: ', dummy_input.cpu().shape)

    export_onnx_file = args.output_path
    
    model.eval().cuda()
    torch.onnx.export(model, dummy_input, export_onnx_file, verbose=True,
